...
const CASES = [
  ['h1', 'fs-h1', [], '0.12em', "the round-2 block's OWN rule at :37956"],
  ['h2', 'bbo-h2', [], '0.12em', "the round-2 block's OWN rule at :37956"],
  ['h3', '', ['bkc-card'], '0.24em', 'a deliberately WIDE uppercase label'],
  ['h3', '', ['bbo-card'], '0.22em', 'a deliberately WIDE uppercase label'],
  ['h3', '', ['udw-counter'], '0.22em', 'a deliberately WIDE uppercase label'],
  ['h3', '', ['wfa-panel-h'], '0.14em', 'Oswald skin, wide label'],
  ['h1', 'wfa-header-title', [], '0.10em', 'Oswald skin masthead'],
  ['h1', '', ['br-page'], '(uppercase Oswald)', 'the brutalist BR skin'],
  ['h1', '', ['title-screen'], '(display)', 'the title screen masthead'],
];
