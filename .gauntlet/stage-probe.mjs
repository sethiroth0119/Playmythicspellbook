/* ⚠ RENAMED BY THE BATTLEFIELD-HEX MERGE.
   This is the battlefield branch's rig, which arrived at .gauntlet/probe.mjs —
   the same path our Node City rig already occupies. The two are unrelated
   tools (that one boots public/node-city/index.html; this one drives the
   battle stage / _harness.html). Ours keeps the canonical name; this one
   moved here so neither is lost. Update any battlefield runbook that still
   says "probe.mjs".                                                        */
