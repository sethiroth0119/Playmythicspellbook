...
export const PHRASES = {
  ...
  /* 🦠 ILLNESS. {v} is the strain's NAME, handed over by the observer from
     /src/plague — a clause that names one is dropped when there is no strain
     to name, per the {v} rule at the top. {n} is the case count. */
  virus: {
    cit: {
      bad: B(
        ['people on my street are coming down with something', 'half the shop was coughing today. Something is going round',
         'my neighbour has been in bed three days and nobody will say with what', 'is anyone else feeling rough this week? Something is about'],
        ['{n} of us are sick now and the clinic is full', 'they are calling it {v}. It is on every street in the district',
         'the {tag} is real — {n} people I know have it', 'nobody is going to work. Whatever this {tag} is, it spreads',
         'my whole block has {v}. Where is the cure?'],
        ['{v} has {i} taken this city. {n} sick and the wards are turning people away',
         'people are dying of {v} and there is no cure on the shelf',
         'the {tag} is everywhere. {n} of us are down with {v}', 'this {tag} has {i} emptied the streets. Nobody goes out']
      ),
      good: G(
        ['I have not heard a cough on this street all week', 'the clinic says the worst of it is over', 'feeling better. Back to work tomorrow'],
        ['{v} is gone. The cure came through and people are back at work', 'we beat the {tag}. Whoever mixed that cure, thank you']
      ),
    },
    dept: {
      bad: B(
        ['we are seeing the first cases of an unidentified illness; residents with symptoms should stay home',
         'a small number of residents have reported symptoms. Clinics are monitoring'],
        ['{v} has been confirmed in the city — {n} residents infected. Clinics are treating; keep water and food coverage up',
         'the {tag} is spreading: {n} active cases of {v}. A cure is being sought through the Research Facility',
         '{n} residents are down with {v}. Clinic capacity and clean water are what slow it'],
        ['public health emergency: {v} has infected {n} residents and the wards are at capacity',
         '{v} is {i} out of control — {n} cases. Until a cure ships, containment and clinics are all we have']
      ),
      good: G(
        ['no active cases of illness in the city this cycle'],
        ['{v} has been cleared. Every case has recovered and the {tag} is over']
      ),
    },
  },
