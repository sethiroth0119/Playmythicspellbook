...
export const UNIT_CARDS = [
  { id: 'goblin',  name: 'Goblin Scout',     icon: '👺', elements: ['shadow'],          factions: ['goblinoid', 'rogue'],         cost: 1, type: 'unit', stats: { hp: 14, atk: 10, def: 5,  mag: 5,  res: 5,  spd: 2 }, learnset: [{ lvl: 1, m: 'quickJab' }, { lvl: 2, m: 'bite' }, { lvl: 3, m: 'slash' }, { lvl: 4, m: 'cleave' }], passive: 'swift', desc: 'Fast but fragile.' },
  { id: 'orc',     name: 'Orc Warrior',      icon: '🧌', elements: ['earth'],           factions: ['goblinoid', 'warrior'],       cost: 2, type: 'unit', stats: { hp: 24, atk: 16, def: 10, mag: 5,  res: 7,  spd: 1 }, learnset: [{ lvl: 1, m: 'slash' }, { lvl: 2, m: 'heavyStrike' }, { lvl: 3, m: 'bash' }, { lvl: 4, m: 'smash' }], passive: 'tough', desc: 'Brutal frontline fighter.' },
  { id: 'sprite',  name: 'Fire Sprite',      icon: '🔥', elements: ['fire'],            factions: ['elemental', 'fairy'],         cost: 2, type: 'unit', stats: { hp: 16, atk: 6,  def: 6,  mag: 18, res: 12, spd: 1 }, learnset: [{ lvl: 1, m: 'fireball' }, { lvl: 2, m: 'arcaneBlast' }, { lvl: 4, m: 'lightning' }], passive: 'sunbather', flying: true, desc: 'Wisp of pure flame. (Flying)' },
  { id: 'troll',   name: 'Cave Troll',       icon: '👹', elements: ['nature', 'earth'], factions: ['goblinoid'],                  cost: 4, type: 'unit', stats: { hp: 40, atk: 22, def: 15, mag: 5,  res: 10, spd: 1 }, learnset: [{ lvl: 1, m: 'slash' }, { lvl: 1, m: 'smash' }, { lvl: 3, m: 'cleave' }], passive: 'regeneration', desc: 'Slow and deadly forest giant.' },
  { id: 'priest',  name: 'Healing Priest',   icon: '✨', elements: ['light'],           factions: ['mage', 'celestial'],          cost: 2, type: 'unit', stats: { hp: 18, atk: 5,  def: 7,  mag: 14, res: 14, spd: 1 }, learnset: [{ lvl: 1, m: 'heal' }, { lvl: 1, m: 'arcaneBlast' }, { lvl: 3, m: 'cleanse' }, { lvl: 4, m: 'divineShield' }], passive: 'none', desc: 'Mends allies.' },
  { id: 'wolf',    name: 'Dire Wolf',        icon: '🐺', elements: ['nature'],          factions: ['beast'],                      cost: 2, type: 'unit', stats: { hp: 20, atk: 14, def: 8,  mag: 5,  res: 8,  spd: 2 }, learnset: [{ lvl: 1, m: 'bite' }, { lvl: 2, m: 'quickJab' }, { lvl: 3, m: 'slash' }], passive: 'swift', desc: 'Hunts in packs.' },
  { id: 'golem',   name: 'Stone Golem',      icon: '🗿', elements: ['earth'],           factions: ['construct', 'elemental'],     cost: 3, type: 'unit', stats: { hp: 32, atk: 14, def: 18, mag: 5,  res: 15, spd: 1 }, learnset: [{ lvl: 1, m: 'smash' }, { lvl: 1, m: 'bash' }, { lvl: 3, m: 'cleave' }], passive: 'thorns', desc: 'Living stone.' },
  { id: 'lich',    name: 'Lich Apprentice',  icon: '💀', elements: ['shadow', 'storm'], factions: ['undead', 'mage'],             cost: 3, type: 'unit', stats: { hp: 20, atk: 6,  def: 8,  mag: 20, res: 16, spd: 1 }, learnset: [{ lvl: 1, m: 'shadowBolt' }, { lvl: 2, m: 'drainLife' }, { lvl: 3, m: 'arcaneBlast' }, { lvl: 4, m: 'focus' }], passive: 'lifesteal', desc: 'Wields dark lightning.' },
  { id: 'archer',  name: 'Elven Archer',     icon: '🏹', elements: ['wind'],            factions: ['rogue'],                      cost: 2, type: 'unit', stats: { hp: 16, atk: 16, def: 6,  mag: 8,  res: 8,  spd: 1 }, learnset: [{ lvl: 1, m: 'pierce' }, { lvl: 2, m: 'quickJab' }, { lvl: 4, m: 'crippleStrike' }], passive: 'none', desc: 'Strikes from a distance.' },
  { id: 'spider',  name: 'Giant Spider',     icon: '🕷️', elements: ['shadow', 'nature'], factions: ['bug'],                        cost: 2, type: 'unit', stats: { hp: 18, atk: 12, def: 6,  mag: 8,  res: 6,  spd: 2 }, learnset: [{ lvl: 1, m: 'bite' }, { lvl: 2, m: 'poisonSting' }], passive: 'venomous', desc: 'Venomous forest hunter.' },
  { id: 'paladin', name: 'Paladin',          icon: '🛡️', elements: ['light'],           factions: ['warrior', 'celestial'],       cost: 4, type: 'unit', stats: { hp: 34, atk: 18, def: 16, mag: 12, res: 14, spd: 1 }, learnset: [{ lvl: 1, m: 'heavyStrike' }, { lvl: 1, m: 'heal' }, { lvl: 3, m: 'bash' }, { lvl: 4, m: 'divineShield' }], passive: 'tough', desc: 'Holy warrior.' },
  { id: 'ice',     name: 'Ice Elemental',    icon: '❄️', elements: ['water', 'wind'],   factions: ['elemental'],                  cost: 3, type: 'unit', stats: { hp: 22, atk: 8,  def: 10, mag: 18, res: 16, spd: 1 }, learnset: [{ lvl: 1, m: 'iceShard' }, { lvl: 2, m: 'arcaneBlast' }, { lvl: 4, m: 'focus' }], passive: 'rainmaker', flying: true, desc: 'Frozen fury, born of storms. (Flying)' },

  // ===== 👽 ALIEN FACTION =====
  // Built around the Infected status — every unit either inflicts it on hit
  // (xenoBond passive @ 25%/hit) or has dedicated moves that do. Aliens
  // themselves are immune (handled in isImmuneToStatus by faction check).
  { id: 'xenoDrone',   name: 'Xeno Drone',      icon: '👾', elements: ['shadow'],            factions: ['alien', 'swarm'],     cost: 1, type: 'unit', stats: { hp: 14, atk: 12, def: 6,  mag: 6,  res: 6,  spd: 2 }, learnset: [{ lvl: 1, m: 'bite' },       { lvl: 2, m: 'xenobite' },   { lvl: 3, m: 'quickJab' }],                       passive: 'xenoBond',  desc: 'Hivemind grunt — fast, fragile, contagious.' },
  { id: 'parasiteHost',name: 'Parasite Host',   icon: '🧟', elements: ['shadow', 'nature'],  factions: ['alien', 'undead'],    cost: 2, type: 'unit', stats: { hp: 20, atk: 14, def: 7,  mag: 10, res: 8,  spd: 1 }, learnset: [{ lvl: 1, m: 'bite' },       { lvl: 2, m: 'sporeCloud' }, { lvl: 3, m: 'xenobite' },  { lvl: 4, m: 'drainLife' }],  passive: 'xenoBond',  desc: 'Once a human — now the carrier walks.' },
  { id: 'hiveDrone',   name: 'Hive Drone',      icon: '🛸', elements: ['storm', 'wind'],     factions: ['alien'],              cost: 3, type: 'unit', stats: { hp: 22, atk: 10, def: 8,  mag: 18, res: 14, spd: 2 }, learnset: [{ lvl: 1, m: 'acidSpray' },  { lvl: 2, m: 'lightning' },  { lvl: 3, m: 'hivecall' }],                       passive: 'xenoBond',  flying: true, desc: 'Scout from the mothership. (Flying)' },
  { id: 'broodTyrant', name: 'Brood Tyrant',    icon: '👽', elements: ['shadow', 'nature'],  factions: ['alien', 'swarm'],     cost: 5, type: 'unit', stats: { hp: 44, atk: 24, def: 16, mag: 18, res: 14, spd: 2 }, learnset: [{ lvl: 1, m: 'xenobite' },   { lvl: 1, m: 'sporeCloud' }, { lvl: 2, m: 'cleave' },    { lvl: 3, m: 'hivecall' },    { lvl: 4, m: 'acidSpray' }],   passive: 'xenoBond',  desc: 'Apex of the swarm — moves with predator grace.' },
];
