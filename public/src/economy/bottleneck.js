...
export function classify(firm, worst) {
  ...
  /* It is a material. Which kind of material problem?
     💸 CASH IS JUDGED AFTER THE MATERIAL, NOT BEFORE. Reported, twice: "Out
     of Cash - Limited by ... 0% impacting many businesses throughout the
     city" — Pharmacy, Fast Food, Cinema, Cannery, Sawmill, Farm and more.
     The cash test used to sit above these lines, so a firm whose binding
     input has NO PRODUCER IN THE CITY was told it was "out of cash: failing,
     not blocked" — true about its balance (it has never sold a unit, so it has
