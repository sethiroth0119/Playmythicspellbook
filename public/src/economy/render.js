...
.eco-wrap{font:12px/1.45 'Crimson Text',Georgia,serif;color:#e8dfc9}
.eco-h{display:flex;align-items:center;gap:6px;margin:10px 0 6px;font-weight:700;
  font-family:'Cinzel',Georgia,serif;
  font-size:11px;letter-spacing:.08em;text-transform:uppercase;color:#9d907a}
.eco-h:first-child{margin-top:0}
.eco-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(88px,1fr));gap:6px}
.eco-stat{background:#1c1813;border:1px solid rgba(198,160,74,.24);border-radius:5px;padding:7px 8px}
.eco-stat b{display:block;font-size:15px;color:#f0e6cc;font-weight:700;line-height:1.2}
.eco-stat span{display:block;font-size:10px;color:#9d907a;margin-top:2px}
.eco-stat.warn b{color:#e0a060}.eco-stat.bad b{color:#e0556a}.eco-stat.good b{color:#9ad17a}
.eco-row{display:flex;align-items:center;gap:7px;padding:5px 7px;border-radius:6px;background:#1c1813;
  border:1px solid rgba(198,160,74,.24);margin-bottom:4px}
.eco-row .nm{flex:1;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.eco-row .vl{font-variant-numeric:tabular-nums;color:#f0e6cc;font-weight:600}
.eco-bar{height:5px;border-radius:3px;background:rgba(198,160,74,.14);overflow:hidden;margin-top:3px}
...
.eco-pill{display:inline-flex;align-items:center;gap:3px;padding:1px 6px;border-radius:99px;
  font-size:10px;font-weight:700;background:rgba(198,160,74,.16);color:#e8dfc9}
.eco-flow{display:grid;grid-template-columns:1fr auto;gap:2px 8px;font-variant-numeric:tabular-nums}
.eco-flow .k{color:#9d907a}.eco-flow .v{color:#f0e6cc;text-align:right}
.eco-trace{display:flex;flex-wrap:wrap;align-items:center;gap:4px;margin-top:5px}
.eco-trace .st{padding:2px 7px;border-radius:4px;background:#1c1813;border:1px solid rgba(198,160,74,.2);font-size:10px}
.eco-trace .st.bad{border-color:#5a2530;background:#2a1620;color:#ffb0bc}
.eco-trace .ar{color:#8d8272;font-size:10px}
.eco-fix{margin-top:5px;padding:6px 8px;border-radius:5px;background:#241f16;border:1px solid rgba(198,160,74,.3);color:#d9cbaa;font-size:11px}
.eco-empty{padding:14px;text-align:center;color:#8d8272;font-size:11px}
.eco-grade{display:inline-block;width:14px;text-align:center;font-weight:700}
.eco-tag{font-size:10px;color:#9d907a}
...
export function renderPanel(s, opts) {
  ...
  /* 👥 "Residents" here is the economy model's OWN household count, which can
     sit a person off the HUD's NPC population (345 vs 346 was reported) — the
     two are synced, not the same variable. The label says whose number it is. */
  h.push(stat('👥 ' + n0(s.population), 'Residents (economy model)'));
