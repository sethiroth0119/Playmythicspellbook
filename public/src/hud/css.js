...
:root{
  ...
  --hu:4px;
  --hud-ink:#e8dcc0; --hud-dim:#9d907a; --hud-gold:#d4af37;
  --hud-ok:#5fd08a; --hud-warn:#e0b84a; --hud-bad:#e07a6a;
  --hud-panel:linear-gradient(180deg,rgba(28,24,19,.97),rgba(10,9,7,.985));
}
...
#nctop{position:absolute;top:0;left:0;right:0;z-index:43;
  ...
  background:linear-gradient(180deg,rgba(14,12,9,.975),rgba(17,15,11,.93));
...
.sbnopause{display:inline-flex;align-items:center;gap:calc(var(--hu));
  padding:calc(var(--hu)*.75) calc(var(--hu)*1.75);border-radius:6px;cursor:help;
  border:1px dashed rgba(212,175,55,.42);background:rgba(12,10,8,.62);
...
.sbnote{position:absolute;top:calc(100% + 8px);left:0;z-index:60;width:min(430px,72vw);
  padding:calc(var(--hu)*3);border:1px solid rgba(212,175,55,.34);border-radius:6px;
...
.sbm{display:flex;align-items:center;gap:calc(var(--hu));
  ...
  border:1px solid rgba(212,175,55,.30);border-radius:6px;
  background:linear-gradient(180deg,rgba(28,24,19,.85),rgba(12,10,8,.9));}
...
.sbbtn{display:inline-flex;align-items:center;gap:calc(var(--hu)*1.5);
  ...
  border:1px solid rgba(212,175,55,.42);border-radius:4px;color:var(--hud-ink);
  background:linear-gradient(180deg,rgba(28,24,19,.94),rgba(10,9,7,.96));
  font-family:'Cinzel',Georgia,'Segoe UI Emoji','Apple Color Emoji','Noto Color Emoji',serif;
...
#ncsb-demand{display:inline-flex;align-items:center;gap:calc(var(--hu)*1.5);
  padding:calc(var(--hu)*.75) calc(var(--hu)*2);cursor:pointer;border-radius:4px;
...
#topbar{position:absolute;top:calc(var(--topbarh) + 8px);left:auto;right:12px;bottom:auto;
  ...
  padding:calc(var(--hu)*4);border-radius:6px;
...
#buildbar .bbtn.tool{display:inline-flex;align-items:center;gap:calc(var(--hu)*1.5);
  width:auto;min-width:0;padding:calc(var(--hu)*1.5) calc(var(--hu)*3);border-radius:4px;}
...
#buildbar{left:0;right:0;bottom:0;transform:none;max-width:none;
  ...
  background:linear-gradient(0deg,rgba(14,12,9,.975),rgba(17,15,11,.9));
...
#ncdm .ncdm-box{width:min(940px,96vw);max-height:100%;display:flex;flex-direction:column;
  position:relative;overflow:hidden;border-radius:6px;background:var(--hud-panel);
...
.ncdm-x{border:1px solid rgba(212,175,55,.35);background:rgba(0,0,0,.3);color:var(--hud-ink);
  border-radius:4px;padding:calc(var(--hu)) calc(var(--hu)*2.5);cursor:pointer;font-size:var(--hf-small);}
...
.ncdm-detail p{font-size:var(--hf-body);line-height:1.65;color:#e8dfc9;margin-bottom:calc(var(--hu)*3);}
...
.ncdm-detail .dwhy .dtxt{font-size:var(--hf-body);line-height:1.6;color:#e8dfc9;margin-top:2px;}
...
.ncdm-detail .dsrc{font-size:var(--hf-micro);letter-spacing:.04em;color:#8a7f6b;margin-top:2px;
...
.ddrow{display:block;width:100%;text-align:left;cursor:pointer;color:var(--hud-ink);
  ...
  background:linear-gradient(180deg,rgba(28,24,19,.92),rgba(12,10,8,.94));
  transition:background .15s,border-color .15s;}
.ddrow:hover{background:linear-gradient(180deg,rgba(44,38,28,.95),rgba(16,14,10,.95));
