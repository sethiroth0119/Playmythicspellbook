...
export const PROP_CATALOG = [
  ...
  { id: 'campfire', label: 'Campfire',     icon: '🔥', cat: 'Props', col: false, fx: { kind: 'fire', y: 0.25, scale: 0.8 } },
  ...
  { id: 'wreckcar',  label: 'Wrecked car',     icon: '🚗', cat: 'Ruins', tint: true, fx: { kind: 'smoke', x: 1.2, y: 1.2, scale: 0.7 } },
  ...
  { id: 'burnttree', label: 'Burnt tree',      icon: '🌲', cat: 'Ruins', fx: { kind: 'smoke', y: 2.6, scale: 0.35 } },
  { id: 'drum',      label: 'Oil drum',        icon: '🛢️', cat: 'Ruins', tint: true },
  { id: 'scrap',     label: 'Scrap heap',      icon: '⚙️', cat: 'Ruins' },
  { id: 'crater',    label: 'Crater',          icon: '💥', cat: 'Ruins', col: false, fx: { kind: 'toxic', y: 0.1, scale: 1.2 } },
  { id: 'generator', label: 'Generator',       icon: '🔋', cat: 'Ruins', tint: true, fx: { kind: 'sparks', x: 0.8, y: 2.3, z: -0.3, scale: 0.6 } },
  { id: 'pylon',     label: 'Energy pylon',    icon: '⚡', cat: 'Ruins', tint: true, fx: { kind: 'motes', y: 4, scale: 0.8 } },
  ...
  // ── VFX emitters (mapforge.vfx.js) — placed like props, tuned in the inspector ──
  { id: 'fx_fire',     label: 'Fire',        icon: '🔥', cat: 'VFX', fxKind: 'fire',      col: false },
  { id: 'fx_bigfire',  label: 'Blaze',       icon: '🔥', cat: 'VFX', fxKind: 'bigfire',   col: false },
  { id: 'fx_smoke',    label: 'Smoke',       icon: '💨', cat: 'VFX', fxKind: 'smoke',     col: false },
  { id: 'fx_darksmoke',label: 'Black smoke', icon: '🌫️', cat: 'VFX', fxKind: 'darksmoke', col: false },
  { id: 'fx_steam',    label: 'Steam',       icon: '♨️', cat: 'VFX', fxKind: 'steam',     col: false },
  { id: 'fx_fog',      label: 'Ground fog',  icon: '🌁', cat: 'VFX', fxKind: 'fog',       col: false },
  { id: 'fx_sparks',   label: 'Sparks',      icon: '✨', cat: 'VFX', fxKind: 'sparks',    col: false },
  { id: 'fx_toxic',    label: 'Toxic gas',   icon: '☣️', cat: 'VFX', fxKind: 'toxic',     col: false },
  { id: 'fx_dust',     label: 'Dust',        icon: '🌪️', cat: 'VFX', fxKind: 'dust',      col: false },
  { id: 'fx_motes',    label: 'Light motes', icon: '✴️', cat: 'VFX', fxKind: 'motes',     col: false },
  // ── Markers ──
