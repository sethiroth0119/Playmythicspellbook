...
function statusHtml() {
  ...
  if (Merc.missing) {
    return '<div class="mrc-note">🛠 The Mercenary Board is not set up on this world yet — <code>sql/122_mercenary_board.sql</code> has not been applied. Everything else in the game is unaffected.</div>';
  }
  if (Merc.error) {
