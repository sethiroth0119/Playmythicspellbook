...
export const FACTIONS = {
  ...
  scum:      { id:'scum',      name:'The Scum',       color:'#c3d63f', short:'SCUM',
               ...
               /* ⚠ PER DAY, NOT PER 4 HOURS. The world used to tick six times a
                  day; it now ticks ONCE, at the day rollover, for everybody at
                  the same moment. The old 4–9 six times over was ~24–54 a day,
                  so a single daily tick at 4–9 would have frozen the city — a
                  district would take three weeks to fall instead of a few days.
                  🔴 THESE NUMBERS ARE MIRRORED IN sql/042 AND MUST STAY EQUAL.
                     drive-mission-coop compares the two and fails the build on
                     drift, because a client and a server that disagree about
                     how fast the factions move is a desync nobody can see. */
               push:{ rate:[12,27], spread:0.45, seed:[8,16] },
  ...
  anomalies: { id:'anomalies', name:'The Anomalies',  color:'#a855f7', short:'ANOM',
               ...
               push:{ rate:[6,18], spread:0.30, seed:[14,26] },
  ...
  scp:       { id:'scp',       name:'SCP Foundation', color:'#ff5a3c', short:'SCP',
               ...
               push:{ rate:[6,12], spread:0.22, seed:[10,18] },
