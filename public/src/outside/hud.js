...
#oc-panel{position:absolute;top:calc(100% + 8px);left:50%;
  ...
  background:linear-gradient(180deg,rgba(28,24,19,.97),rgba(10,9,7,.985));
  border:1px solid rgba(198,160,74,.34);border-radius:6px;padding:14px 16px;
  box-shadow:0 14px 40px rgba(0,0,0,.65);color:#e8dfc9;font-size:12px;line-height:1.5;
...
#oc-panel .oc-lede{color:#9d907a;margin:0 0 10px;}
#oc-panel .oc-row{display:flex;gap:9px;align-items:flex-start;padding:7px 0;
  border-top:1px solid rgba(255,255,255,.07);}
#oc-panel .oc-row b{display:block;color:#e8dcc0;font-size:11.5px;letter-spacing:.05em;}
#oc-panel .oc-row span{color:#9d907a;}
#oc-panel .oc-ok{color:#8fd6ab;} #oc-panel .oc-no{color:#e08a76;}
#oc-panel .oc-fix{margin-top:9px;padding:8px 10px;border-radius:5px;
  background:rgba(226,110,92,.12);border:1px solid rgba(226,110,92,.3);color:#f0cfc4;}
#oc-panel .oc-seam{margin-top:9px;color:#8d8272;font-size:10.5px;}
#oc-panel .oc-close{position:absolute;right:9px;top:7px;cursor:pointer;color:#9d907a;
