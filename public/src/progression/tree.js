/* ══════════════════════════════════════════════════════════════════════════
   ...
   ── THE SHAPE OF A NODE ────────────────────────────────────────────────────
     ...
     level    🏙 the CITY LEVEL (node-city cityLevel(), 1..25, fed by the
              Cinder the city's buildings earn) this node requires. Absent or
              1 = no requirement. The deeper rungs carry one so a city has to
              earn its way to towers, rail and the Mythic districts rather
              than buy the points and skip there; a host that hands over no
              level reader fails OPEN (state.js levelState).
...
export const NODES = [
  ...
  { id: 'civ_shelter', cat: 'civ', row: 3, col: 2, cost: 2, level: 3, req: ['civ_services'],
    name: 'Storm Shelters',
  ...
  { id: 'civ_landmark', cat: 'civ', row: 2, col: 2, cost: 3, level: 5, req: ['civ_services'],
  ...
  { id: 'res_rent', cat: 'res', row: 0, col: 2, cost: 1, req: ['res_row'],
    ...
    zones: ['r_rent'] },
  { id: 'res_apt', cat: 'res', row: 2, col: 2, cost: 2, level: 3, req: ['res_row'],
    name: 'Apartments',
  ...
  { id: 'res_mansion', cat: 'res', row: 3, col: 1, cost: 3, level: 4, req: ['res_row'],
    name: 'Mansions',
  ...
  { id: 'res_condo', cat: 'res', row: 2, col: 3, cost: 3, level: 6, req: ['res_apt'],
    name: 'Condominiums',
  ...
  { id: 'res_mixed', cat: 'res', row: 3, col: 3, cost: 3, level: 8, req: ['res_apt', 'com_high'],
    name: 'Mixed Use',
  ...
  { id: 'res_high', cat: 'res', row: 1, col: 3, cost: 4, level: 12, req: ['res_apt', 'sci_urban'],
    name: 'High-Density Towers',
    desc: 'The tallest residential the city builds. Needs the engineering before it needs the land.',
    zones: ['r_high'] },

  /* ══ 🛒 COMMERCE & OFFICE ═══════════════════════════════════════════════ */
  { id: 'com_high', cat: 'com', row: 0, col: 1, cost: 2, level: 4, req: ['civ_basic'],
  ...
  { id: 'com_district', cat: 'com', row: 1, col: 2, cost: 2, level: 5, req: ['com_high'],
  ...
  { id: 'com_night', cat: 'com', row: 0, col: 3, cost: 3, level: 9, req: ['com_district', 'civ_landmark'],
  ...
  { id: 'com_luxury', cat: 'com', row: 1, col: 3, cost: 4, level: 12, req: ['com_district', 'sci_urban'],
    name: 'Luxury Retail',
  ...
  { id: 'off_district', cat: 'com', row: 3, col: 2, cost: 2, level: 6, req: ['off_low'],
    name: 'Financial District',
    desc: 'An office park told what it is for: trusts and funds rather than laboratories.',
    specs: ['o_fin'] },
  { id: 'off_high', cat: 'com', row: 2, col: 3, cost: 4, level: 12, req: ['off_low', 'sci_urban'],
    name: 'Office Towers',
  ...
  { id: 'ind_heavy', cat: 'ind', row: 1, col: 2, cost: 2, level: 4, req: ['ind_extract'],
    name: 'Heavy Industry',
  ...
  { id: 'ind_district', cat: 'ind', row: 0, col: 2, cost: 2, level: 7, req: ['ind_heavy'],
  ...
  { id: 'ind_ware', cat: 'ind', row: 1, col: 3, cost: 3, level: 9, req: ['ind_heavy', 'sci_materials'],
    licence: 'warehouse',
  ...
  { id: 'ind_works', cat: 'ind', row: 2, col: 4, cost: 5, level: 15, req: ['ind_ware', 'ind_district'],
  ...
  { id: 'tra_bus', cat: 'tra', row: 1, col: 1, cost: 2, req: ['tra_basic'], licence: 'bus',
    ...
    buildings: ['busstop'] },
  { id: 'tra_rail', cat: 'tra', row: 1, col: 2, cost: 4, level: 10, req: ['tra_bus'], licence: 'rail',
    name: 'Rail Network',
  ...
  { id: 'sci_urban', cat: 'sci', row: 1, col: 1, cost: 3, level: 8, req: ['sci_lab'],
    ...
    zones: [], buildings: [] },
  { id: 'sci_containment', cat: 'sci', row: 0, col: 2, cost: 3, level: 6, req: ['sci_lab'],
  ...
  { id: 'sci_genetics', cat: 'sci', row: 2, col: 1, cost: 4, level: 10, req: ['sci_lab'], licence: 'genelab',
