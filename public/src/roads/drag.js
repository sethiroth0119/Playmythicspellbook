...
#nrc-panel{position:absolute;left:50%;transform:translateX(-50%);bottom:92px;z-index:6;
  ...
  border-radius:6px;padding:9px 11px 10px;backdrop-filter:blur(6px);
...
#nrc-panel .hint{color:var(--mist,#9d907a);font-size:11px;flex:1;min-width:0}
#nrc-panel .x{margin-left:auto;background:none;border:none;color:var(--mist,#9d907a);cursor:pointer;font-size:13px}
#nrc-panel .row{display:flex;gap:6px;flex-wrap:wrap;align-items:center;margin-bottom:8px}
#nrc-panel .t{border:1px solid var(--edge,rgba(198,160,74,.34));background:#1c1813;color:var(--bone,#e9e0cc);
...
#nrc-panel .c{display:flex;align-items:center;gap:6px;border:1px solid rgba(255,255,255,.12);
  background:rgba(0,0,0,.32);border-radius:5px;padding:4px 8px 4px 5px;cursor:pointer;
...
#nrc-panel .pr{color:var(--mist,#9d907a);font-variant-numeric:tabular-nums;font-size:10px}
...
#nrc-panel .sel{flex:1;min-width:0;color:var(--mist,#9d907a);font-size:11px;line-height:1.4}
#nrc-panel .sel b{color:var(--bone,#e9e0cc)}
#nrc-panel .meter{white-space:nowrap;font-size:11px;color:var(--mist,#9d907a);font-variant-numeric:tabular-nums}
