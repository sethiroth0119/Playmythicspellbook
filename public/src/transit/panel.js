...
function ensureStyle() {
  ...
  #tr-ov{position:fixed;inset:0;z-index:9720;display:flex;align-items:center;justify-content:center;
    background:rgba(6,5,4,.74);backdrop-filter:blur(3px);padding:18px}
  #tr-panel{width:min(760px,96vw);max-height:92vh;overflow:auto;border-radius:6px;padding:1rem 1.15rem 1.1rem;
    background:linear-gradient(180deg,rgba(28,24,19,.97),rgba(10,9,7,.985));border:1px solid rgba(198,160,74,.34);
  ...
  #tr-panel .sub{font-size:11px;color:var(--mist,#9d907a);margin-bottom:.7rem;line-height:1.5}
  #tr-panel .card{background:rgba(0,0,0,.32);border:1px solid rgba(198,160,74,.16);border-radius:5px;
  ...
  #tr-panel .row span{color:var(--mist,#9d907a)} #tr-panel .row b{color:#f0e6cc}
  ...
  .tr-meter i{display:block;height:100%;border-radius:99px;background:linear-gradient(90deg,#4fb0a5,#6fbf85)}
  .tr-lic{display:flex;gap:.5rem;flex-wrap:wrap;margin-bottom:.55rem}
  .tr-lic div{flex:1 1 210px;border-radius:5px;padding:.5rem .6rem;font-size:11.5px;line-height:1.45;
  ...
  .tr-lic .note{color:var(--mist,#9d907a)} .tr-lic .note b{color:#e8dfc9}
  .tr-line{border:1px solid rgba(198,160,74,.16);border-radius:5px;padding:.5rem .6rem;margin-bottom:.5rem;
    background:rgba(255,255,255,.035)}
  .tr-line .hd{display:flex;align-items:center;gap:.5rem;flex-wrap:wrap}
  .tr-sw{width:16px;height:16px;border-radius:3px;flex:0 0 auto;border:1px solid rgba(0,0,0,.5);cursor:pointer}
  .tr-name{flex:1 1 130px;min-width:110px;padding:.28rem .45rem;border-radius:4px;font-size:12px;
  ...
  .tr-chip{font-size:9.5px;font-weight:800;letter-spacing:.1em;padding:.16rem .5rem;border-radius:99px;
    background:rgba(255,255,255,.07);color:#c8bda6;white-space:nowrap}
  .tr-chip.bad{background:rgba(196,71,63,.22);color:#f4a79f}
  .tr-chip.good{background:rgba(60,140,95,.25);color:#a8e9c2}
  .tr-line .fx{font-size:11px;color:var(--mist,#9d907a);margin-top:.35rem;line-height:1.5}
  .tr-btns{display:flex;gap:.35rem;flex-wrap:wrap;margin-top:.45rem}
  .tr-btns button{padding:.28rem .6rem;border-radius:4px;cursor:pointer;font-size:10.5px;font-weight:700;
    border:1px solid rgba(255,255,255,.16);background:rgba(255,255,255,.05);color:#c8bda6}
  ...
  #tr-panel .foot button{flex:1;padding:.5rem;border-radius:4px;cursor:pointer;font-size:12px;
    border:1px solid rgba(255,255,255,.16);background:rgba(255,255,255,.05);color:#c8bda6}
  #tr-pickbar{position:fixed;left:50%;top:12px;transform:translateX(-50%);z-index:9500;
    display:flex;align-items:center;gap:.6rem;padding:.5rem .8rem;border-radius:6px;
    background:linear-gradient(180deg,rgba(28,24,19,.97),rgba(10,9,7,.985));border:1px solid rgba(198,160,74,.5);
    box-shadow:0 12px 40px rgba(0,0,0,.7);color:#e8dfc9;font-size:12px;max-width:94vw}
  #tr-pickbar b{color:#f0d78a} #tr-pickbar .mist{color:var(--mist,#9d907a);font-size:11px}
  #tr-pickbar button{padding:.32rem .8rem;border-radius:4px;cursor:pointer;font-size:11px;font-weight:800;
