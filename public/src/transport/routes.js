...
/* ═══ ADJACENCY ═════════════════════════════════════════════════════════════
   ...
   (the `freightdepot` def's `effect:` line in src/city/production.data.js —
   grep the id; the colon cite that used to sit here pointed at the array's
   closing bracket, and for a while at a file that did not hold the def at
   all), and the server
   ...
   column, and the `freightdepot` effect() in src/city/production.data.js.
