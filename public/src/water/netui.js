...
#nwp-strip .nwphint{color:var(--mist,#9d907a);font-size:11px}
#nwp-strip .nwpwarn{color:#ffbf9a}
#nwp-strip .nwpx{background:none;border:0;color:var(--mist,#9d907a);cursor:pointer;font-size:13px;
...
async function commit(d) {
  ...
  const price = tilePrice();
  if (price == null) {
    toast('🚰 Pipe has no price in this city, so nothing was laid. (The city never handed the water system its cost settings.)', 'bad');
