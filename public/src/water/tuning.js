...
export const WATER = {
  ...
  col: {
    ...
    well:        '#4fd8e8',
    wellDry:     '#8a8f98',
    /* 📍 The focused source (bug-mu2r4z2p). Warm yellow because every ramp in
       this table is blue, green, olive or grey — it must not be mistaken for
       a reading of any of them. */
    focus:       '#ffe066',
    stress:      '#ff7a4d',
