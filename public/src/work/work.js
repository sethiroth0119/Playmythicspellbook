...
export const BUILDING_WORK = {
  ...
  /* ════════════════════════════════════════════════════════════════════════
     👷 THE REST OF THE CITY — added because 31 of 175 building types was not
     a work system, it was a demo of one.
     ════════════════════════════════════════════════════════════════════════
     THE ASK: "add the units being assigned to city buildings for work and
     boosting of producing."

     WHAT WAS WRONG: everything below this line had a `crew` requirement — the
     city counted them as staffed workplaces and charged them a wage bill —
     and workNeeds() returned [] for every one of them, so slotsAt() answered
     0 and the Work Crew card never rendered. A player who unlocked the whole
     industrial chain, built a Steel Mill and a Chip Fab and six power
     stations, then went looking for somewhere to post their units, found that
     the only postable buildings in their city were the starter farms and
     mines. Nothing said why, because from the UI's side there was nothing to
     say — the card simply was not there.

     ⚠ EVERY TRADE HERE IS ONE OF THE THIRTEEN. No new work kinds: a unit's
       suitability is rolled from its card against that fixed set, so inventing
       a 'teaching' or 'retail' kind would make every existing unit unsuited to
       the new buildings and the feature would look broken on a full roster.
     ⚠ PRIMARY FIRST — the first entry is what the building is really about,
       and it is what the crew dialog sorts and suggests on.
     ⚠ THE slotsAt() GUARD STILL APPLIES. A building the tick does not
       multiply gets no slots however many trades it lists here; listing a
       trade is permission, not a promise. */

  // ── ⚡ power. Renewables are watched; combustion is fed. ──
  wind:        ['generating', 'handiwork'],
  solar:       ['generating', 'handiwork'],
  hydro:       ['watering', 'generating'],
  geothermal:  ['generating', 'mining'],
  battery:     ['generating', 'handiwork'],
  coal:        ['kindling', 'generating'],
  gas:         ['kindling', 'generating'],
  oil:         ['kindling', 'generating'],
  nuclear:     ['generating', 'research'],
  incinerator: ['kindling', 'transport'],

  // ── 🏭 heavy industry: heat, ore and a hammer ──
  deepmine:    ['mining', 'generating'],
  alloyworks:  ['kindling', 'mining'],
  steelmill:   ['kindling', 'mining'],
  alusmelter:  ['kindling', 'mining'],
  coppersmelt: ['kindling', 'mining'],
  rollingmill: ['handiwork', 'kindling'],
  alloymill:   ['kindling', 'handiwork'],
  partspress:  ['handiwork', 'mining'],
  engineworks: ['handiwork', 'generating'],
  wireworks:   ['handiwork', 'generating'],
  glassworks:  ['kindling', 'handiwork'],
  flatglass:   ['kindling', 'cooling'],
  tyreworks:   ['kindling', 'handiwork'],
  rubberworks: ['kindling', 'handiwork'],
  plasticworks:['kindling', 'cooling'],
  joinery:     ['lumbering', 'handiwork'],
  panelmill:   ['lumbering', 'handiwork'],
  papermill:   ['lumbering', 'watering'],
  printworks:  ['handiwork', 'performing'],

  // ── ⚗ process industry: it is chemistry, so it is research and cooling ──
  refinery:    ['kindling', 'generating'],
  fuelrefine:  ['kindling', 'generating'],
  gasplant:    ['generating', 'kindling'],
  chemworks:   ['research', 'cooling'],
  acidworks:   ['research', 'cooling'],
  solventworks:['research', 'kindling'],
  polymerplant:['kindling', 'handiwork'],
  polycompound:['cooling', 'handiwork'],
  adhesiveplant:['cooling', 'handiwork'],
  paintworks:  ['handiwork', 'cooling'],
  fiberplant:  ['handiwork', 'planting'],
  medchem:     ['medicine', 'research'],

  // ── 🔬 semiconductors: the cleanest rooms in the city ──
  semichem:    ['research', 'cooling'],
  semimat:     ['research', 'cooling'],
  waferline:   ['research', 'handiwork'],
  chipfab:     ['research', 'generating'],
  electbench:  ['handiwork', 'generating'],
  electronbench:['handiwork', 'research'],
  ...
  outfall:     ['watering', 'handiwork'],
  riftbore:    ['research', 'mining'],

  // ── 📦 logistics ──
  truckdepot:  ['transport', 'handiwork'],
  warehouse:   ['transport', 'handiwork'],
  caravanpost: ['transport', 'guarding'],

  /* ── 🏬 the high street. THESE ARE THE ONES THE ASK IS REALLY ABOUT: as of
     the patronage round every standing shop takes Cinder off residents who
     walk in, and a posted unit is what makes a shop better at that. Before
     this, not one building a player could see earning money was crewable. ── */
  clothier:    ['handiwork', 'performing'],
  greatbuy:    ['transport', 'performing'],
  furnistore:  ['handiwork', 'transport'],
  gamestore:   ['performing', 'handiwork'],
  weaponshop:  ['handiwork', 'guarding'],
  pharmacy:    ['medicine', 'cooling'],
  fastfood:    ['kindling', 'transport'],
  retail:      ['transport', 'performing'],
  cinema:      ['performing', 'generating'],
  /* 🏋 The Gym arrived with patronage and had nowhere to put a unit either. */
  gym:         ['performing', 'guarding'],
  resthouse:   ['performing', 'cooling'],

  /* ── 🏫 the school ladder. 'research' first: what a school produces is
     schooling, and 'performing' is the standing-up-in-front-of-people half. ── */
  elemschool:  ['research', 'performing'],
  midschool:   ['research', 'performing'],
  highschool:  ['research', 'performing'],
  college:     ['research', 'performing'],
  university:  ['research', 'performing'],
  employoffice:['performing', 'research'],

  // ── 🏦 desks. Finance is people and paperwork, not a trade floor. ──
  office:      ['research', 'performing'],
  forge:       ['research', 'performing'],
  indexfund:   ['research', 'performing'],
  holdco:      ['research', 'performing'],

  // ── 🛡 civic and safety ──
  stormshelter:['guarding', 'handiwork'],
  containment: ['guarding', 'research'],
  graveyard:   ['planting', 'guarding'],
  cemetery:    ['planting', 'guarding'],
  stadium:     ['performing', 'guarding'],
  // 🐎 Husbandry is the closest of the thirteen to keeping a Kalon well.
  kalonstable: ['watering', 'planting'],
};
