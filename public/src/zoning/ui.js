...
#nz-panel .nzhint{color:var(--mist,#9d907a);font-size:11px;flex:1;min-width:0}
#nz-panel .nzx{margin-left:auto;background:none;border:none;color:var(--mist,#9d907a);cursor:pointer;font-size:13px}
#nz-panel .nzrow{display:flex;gap:6px;flex-wrap:wrap;align-items:center;margin-bottom:8px}
#nz-panel .nzt{border:1px solid var(--edge,rgba(198,160,74,.34));background:#1c1813;color:var(--bone,#e9e0cc);
...
#nz-panel .nzgl{color:var(--mist,#9d907a);font-size:10px;letter-spacing:.12em;margin:0 0 3px 2px}
...
#nz-badge{margin-left:4px;font-size:10px;color:var(--mist,#9d907a)}
#nz-panel .nzgate{margin-top:7px;border-top:1px solid rgba(255,255,255,.08);padding-top:7px;
  font-size:11px;line-height:1.4;color:var(--mist,#9d907a)}
