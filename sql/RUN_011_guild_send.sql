-- =====================================================================
-- MIGRATION 011 - Guild Wire hardening. Run after 001-010.
-- Plain ASCII. Idempotent.
-- !! DEPLOY THE GAME AND MARKET BUILDS FIRST (v120h5+). This revokes the
--    direct INSERT, so an OLD client can no longer post to the wire.
-- =====================================================================
