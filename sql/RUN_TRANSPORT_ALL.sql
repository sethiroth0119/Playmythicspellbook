...
--   1. 073_transport_companies.sql   THE BUSINESS — charters, rigs, contracts, the ledger, the caps, the money path
--   2. 074_haul_requests.sql         THE BOARD — a shipper posts, a carrier accepts (atomic)
--   3. 075_node_depot_index.sql      THE DEPOT GATE — which nodes can receive freight, and the refusal
--   4. 076_depot_earnings.sql        THE EARNINGS — the index fix, the unloading fee, and claiming it
--
-- Assembled 2026-08-29
-- ══════════════════════════════════════════════════════════════════════════
